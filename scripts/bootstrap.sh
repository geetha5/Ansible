...
# This will bootstrap an EC2 instance and install ansible 
# and other needed tools
##

echo "running bootstrap script"

#updating pre-installed stuff
yum -y update
...
# install jq gcc
yum -y install jq gcc libffi-devel openssl-devel
...
# install boto3
${pip_command} install boto3

# fixes boto core compatibility issue
